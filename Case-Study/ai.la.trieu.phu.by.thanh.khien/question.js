let question = [// Mảng câu hỏi
    ...
    "Đâu là tên một bãi biển ở Quảng Bình?",
    "Haiku là thể thơ truyền thống của nước nào?",
    "Thơ Hai-cư là thể thơ truyền thống của nước nào?",
...
let answers = [// Mảng các đáp án
    ...
    ["A: Ếch", "B: Nhái", " C: Thằn lằn", "D: Cóc"],
    ["A: Đá Lăn", "B: Đá Nhảy", "C: Đá Chạy", "D: Đá Bò"],
    ["A: Nhật Bản", "B: Mông Cổ", "C: Trung Quốc", "D: Hàn Quốc"],
